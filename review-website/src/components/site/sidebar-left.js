    ...
    return (
        <div className="sidebar-master">
            <div className="sidebar-styling">
                ...
                <Row className="sidebarIcon"><Link to="/profile"><SidebarItem src={pfp} /></Link></Row>
                <Row className="sidebarIcon"><Link to="/lists"><SidebarItem src={listpic} /></Link></Row>
                <Row className="sidebarIcon"><Link to="/catalogs"><SidebarItem src={catalog} /></Link></Row>
                </Col>
            </div>
